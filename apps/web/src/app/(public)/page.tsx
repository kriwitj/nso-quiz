...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-nso-surface">
      ...
      {/* Hero */}
      <section className="px-5 md:px-6 py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-nso-primary-fixed/50 border border-nso-primary/20 text-nso-primary text-xs md:text-sm font-medium mb-6 md:mb-8">
            <Zap className="w-3.5 h-3.5 md:w-4 md:h-4" />
            <span>ระบบแบบทดสอบออนไลน์ Real-time</span>
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-5 md:mb-6 max-w-3xl">
            ทดสอบความรู้สถิติ
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <Link
              href="/register"
              className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3.5 md:py-4 rounded-xl bg-nso-primary text-white font-semibold text-sm md:text-base hover:bg-nso-primary-container transition-all shadow-primary group"
            >
              เริ่มต้นใช้งานฟรี
            ...
            <Link
              href="/join"
              className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3.5 md:py-4 rounded-xl bg-white border border-nso-outline-variant/50 text-foreground font-semibold text-sm md:text-base hover:bg-nso-surface-low transition-all"
            >
              <Play className="w-4 h-4 md:w-5 md:h-5 text-nso-secondary" />
              เข้าร่วมเกม
            </Link>
          </div>

          {/* Stats row */}
          <div className="mt-10 md:mt-16 flex flex-wrap gap-6 md:gap-8">
            {[
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={item.step}
                className="bg-white rounded-2xl border border-nso-outline-variant/30 shadow-card p-4 md:p-6 flex items-start gap-4 md:gap-6"
              >
                <div className="w-11 h-11 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-nso-primary flex items-center justify-center flex-shrink-0">
                ...
                <Link
                  href={item.href}
                  className="flex-shrink-0 flex items-center gap-1 text-nso-primary text-xs md:text-sm font-semibold hover:underline"
                >
      ...
      <section className="px-5 md:px-6 py-14 md:py-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-nso-primary rounded-2xl md:rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
